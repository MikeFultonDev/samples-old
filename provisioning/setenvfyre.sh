...
#ZOS_TMPDIR     The z/OS remote directory that will be used for temporary files
#               For z/OS as a Service systems, this is /zaas1/tmp
...
#SCP             Command to use for scp (typically just scp, but sometimes scp -P <port>)
#
export ZOS_USER="ibmuser"
export ZOS_ADMIN="ibmuser"
export ZOS_HOST="mike11.fyre.ibm.com"
